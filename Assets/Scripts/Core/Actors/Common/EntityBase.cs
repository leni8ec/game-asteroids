...
namespace Asteroids.Core.Actors.Common {
    ...
    #region Sugar
        ...
        /// <summary>
        /// The world space forward of the entity transform (transform.up)
        /// </summary>
        public abstract Vector3 Forward { get; }
        /// <summary>
        /// Entity target direction
        /// <remarks> It's <b>not</b> the same as <see cref="Forward"/></remarks>
        /// </summary>
